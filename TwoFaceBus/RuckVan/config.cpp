...
class CfgSlots
{
	...
	class Slot_Van_01_door_2_1 //stopped arround here have to edit all display names & selection
	{
		name="Van_01_door_1_2";
	...
	class Slot_Van_01_door_3_1
	{
		name="Van_01_door_3_1";
	...
	{
		name="55galDrum_1";
		displayName="Van_01 55galDrum_1";
	...
	{
		name="55galDrum_2";
		displayName="Van_01 55galDrum_2";
...
class cfgvehicles
{
	...
	class Van_01_wheel: CarWheel
	{
		...
		model="RuckVan\proxy\van_01_wheel.p3d";
		weight=20000;
		itemSize[]={6,6};
		inventorySlot[]=
		{
	...
	class Van_01_wheel_ruined: CarWheel
	{
		scope=2;
		displayName="#STR_CfgWheel0";
		model="RuckVan\proxy\van_01_wheel_ruined.p3d";
		weight=10000;
		inventorySlot[]=
		{
			"Van_01_wheel_1_1",
	...
	class Van_01_door_1_1: HatchbackDoors_Driver
	{
		...
		Model="RuckVan\proxy\van_01_door_1_1.p3d";
		weight=15000;
		itemSize[]={10,10};
		itemBehaviour=0;
	...
	class Van_01_door_2_1: HatchbackDoors_Driver
	{
		...
		Model="RuckVan\proxy\van_01_door_2_1.p3d";
		weight=15000;
		itemSize[]={10,10};
		itemBehaviour=0;
	...
	class Van_01_door_2_2: HatchbackDoors_Driver
	{
		...
		Model="RuckVan\proxy\van_01_door_2_2.p3d";
		weight=15000;
		itemSize[]={10,10};
		itemBehaviour=0;
	...
	class van_01_trunk_1: HatchbackTrunk
	{
		scope=2;
		displayName="#STR_CfgTrunk0";
		descriptionShort="Trunk";
		Model="RuckVan\proxy\van_01_trunk_1.p3d";
		weight=15000;
		inventorySlot[]=
		{
			"van_01_trunk_1"
	...
	class van_01_base: carscript
	{
		...
		dashboardMatOn="RuckVan\data\van_01_int_panel.rvmat";
		dashboardMatOff="dz\vehicles\wheeled\offroadhatchback\data\niva_dashboard.rvmat";
		frontReflectorMatOn="dz\vehicles\wheeled\offroadhatchback\data\niva_lights.rvmat";
		frontReflectorMatOff="RuckVan\data\van_01_body.rvmat";
		brakeReflectorMatOn="RuckVan\data\van_01_body.rvmat";
		brakeReflectorMatOff="RuckVan\data\van_01_body.rvmat";
		ReverseReflectorMatOn="RuckVan\data\van_01_body.rvmat";
		ReverseReflectorMatOff="RuckVan\data\van_01_body.rvmat";
		TailReflectorMatOn="RuckVan\data\van_01\van_01_body.rvmat";
		TailReflectorMatOff="RuckVan\data\van_01_body.rvmat";
		hiddenSelections[]=
		{
			"light_1_1",
			"light_2_1",
		...
		hiddenSelectionsMaterials[]=
		{
			"dz\vehicles\wheeled\offroadhatchback\data\headlights_glass.rvmat",
			"dz\vehicles\wheeled\offroadhatchback\data\headlights_glass.rvmat",
			"RuckVan\data\van_01_body.rvmat",
			"RuckVan\data\van_01_body.rvmat",
			"RuckVan\data\van_01_body.rvmat",
			"RuckVan\data\van_01_body.rvmat",
			"RuckVan\data\van_01_body.rvmat",
	...
	class Van_01: van_01_Base
	{
		...
		Model="RuckVan\proxy\van_01.p3d";
		maxspeed=40;
		attachments[]=
		{
			"CarBattery",
...
class CfgNonAIVehicles
{
	...
	class ProxyVan_01_wheel_destroyed: ProxyVehiclePart
	{
		model="RuckVan\proxy\van_01_wheel_ruined.p3d";
		inventorySlot[]=
		{
	...
	{
		Model="RuckVan\proxy\van_01_door_1_1";
		inventorySlot="Van_01_door_1_1";
	};
	...
	{
		model="RuckVan\proxy\Van_01_Trunk_2.p3d";
